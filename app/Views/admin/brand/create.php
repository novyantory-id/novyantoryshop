...
<div class="card">
    <div class="card-body">
        ...
        <form action="<?= base_url('admin/brand/store') ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
...
<script>
    ...
    function sinkronInput() {
        ...
        const slug = nama_brand.toLowerCase().replace(/\s+/g, '-').replace(/[^a-z0-9\-]/g, '');

        // sinkronisasi ke slug_kategori
        slug_brand.value = slug;
    }
