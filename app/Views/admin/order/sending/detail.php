                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        <table class="table">
                            ...
                            <form action="<?= base_url('admin/order/sending/status/' . $orders['nomor_pesanan']) ?>" method="post">
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <input type="text" class="form-control border-0 border-bottom" name="no_resi">
                                    </td>
                                </tr>
                                <tr>
                                    <th>
