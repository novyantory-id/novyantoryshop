                    ...
                    <div class="card-body table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <input type="text" class="form-control border-0 border-bottom" name="no_resi" value="<?= $orders['no_resi'] ?>" readonly>
                                </td>
                            </tr>
                            <tr>
                                <th>
                                ...
                                <td></td>
                                <td>
                                    <?php if ($orders['status_order'] === 'finished') : ?>
                                        <p class="fst-italic text-success">Pesanan telah diterima</p>
                                    <?php endif ?>
                                </td>
                            </tr>
                        </table>
