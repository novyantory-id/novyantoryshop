...
<div class="container">
    ...
    <div class="status-konfirmasi mb-3">
        <div class="row">
            <div class="col-9">
                <h5>Pesananmu akan segera dikemas oleh Penjual</h5>
                <p>Pengemasan memerlukan waktu berdasarkan antrian pesanan</p>
            </div>
